...
namespace Microsoft.WindowsAzure.Build.Tasks
{
    ...
    public class SmartTestingTask : Task
    {
        ...
        private string scriptFileName = "GetPullRequestFileChanges.ps1";
        ...
        {          
            ...
            if (int.TryParse(PullRequestNumber, out ParsedPullRequestNumber))
            {
                ...
                var GetFilesScript = File.ReadAllText(GetFileChangesDetectorScriptPath());
        ...
        private string GetFileChangesDetectorScriptPath()
        {
